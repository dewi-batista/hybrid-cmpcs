from models.cm_discrim import ContinuousMixture
...
def bins_lo(
    ...
    # embeds z_sampler in an n_bins by latent_dim look-up table
    ...
    epoch_iterator = tqdm(range(max_epochs)) if progress_bar else range(max_epochs) # progress bar things
