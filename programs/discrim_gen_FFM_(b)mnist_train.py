...
train_discrim = True
model_type = 'discrim' if train_discrim else 'gen'
...
n_bins_list = [2 ** k for k in range(14, 15)] # every element of this list corresponds to a model to train
...
for n_bins in n_bins_list:
    ...
    # trainer set up
    decoder_arch = 'tConv'
    # model_path = f'/logs/{dset}/{model_type}/latent_dim_{latent_dim}/num_bins_{n_bins}' # for mnist
    model_path = f'/logs/{dset}/{model_type}/{decoder_arch}/latent_dim_{latent_dim}/num_bins_{n_bins}' # for bmnist
    print(model_path)
